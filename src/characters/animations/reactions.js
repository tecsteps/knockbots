...
const flinchHigh = makeClip('r.flinchHigh', { duration: 18, blendIn: 1, blendOut: 5 }, [
  { t: 0, ease: 'snap', pose: STANCE, root: [0, STANCE_Y, 0] },
  { t: 2, ease: 'quad', pose: add(STANCE, { neck: [-15, -5, -5], head: [-27, -11, -9], clavicle_L: [0, 0, 3], shoulder_L: [-4, 0, 0] }), root: [0, STANCE_Y, -0.025] },
  { t: 4, ease: 'quad', pose: add(STANCE, { spine02: [-7, 2, 2], chest: [-13, 5, 4], neck: [-16, -4, -5], head: [-30, -10, -9], clavicle_L: [-3, 0, 6], clavicle_R: [-3, 0, -4], shoulder_L: [8, 0, 6], shoulder_R: [6, 0, -5], elbow_L: [10, 0, 0] }), root: [0, STANCE_Y - 0.008, -0.075] },
...
const flinchMid = makeClip('r.flinchMid', { duration: 18, blendIn: 1, blendOut: 5 }, [
  { t: 0, ease: 'snap', pose: STANCE, root: [0, STANCE_Y, 0] },
  { t: 2, ease: 'quad', pose: add(STANCE, { hips: [6, 2, 0], spine01: [7, 0, 0], spine02: [8, 0, 0], chest: [7, 2, 0], neck: [4, 0, 0], head: [7, 0, 0], clavicle_L: [4, 0, -4], clavicle_R: [4, 0, 4], elbow_L: [-8, 0, 0], elbow_R: [-4, 0, 0] }), root: [0, STANCE_Y - 0.03, -0.045] },
...
const flinchLow = makeClip('r.flinchLow', { duration: 16, blendIn: 1, blendOut: 5 }, [
  { t: 0, ease: 'snap', pose: STANCE, root: [0, STANCE_Y, 0] },
  { t: 2, ease: 'quad', pose: add(STANCE, { hip_L: [-8, 0, -6], knee_L: [12, 0, 0], hips: [3, 0, 4], chest: [3, 0, -2], head: [4, 0, -2] }), root: [0, STANCE_Y - 0.045, -0.02] },
...
const crumple = makeClip('r.crumple', { duration: 54, blendIn: 1, blendOut: 8 }, [
  { t: 0, ease: 'snap', pose: STANCE, root: [0, STANCE_Y, 0] },
  { t: 4, ease: 'quad', pose: add(over(STANCE, A_CLUTCH), { hips: [12, 4, 0], spine01: [14, 0, 0], spine02: [16, 0, 0], chest: [17, 3, -2], neck: [10, 2, 0], head: [18, 2, 0], knee_L: [14, 0, 0], knee_R: [12, 0, 0], hip_L: [-10, 0, 0], hip_R: [-8, 0, 0] }), root: [0, -0.155, -0.05] },
  { t: 13, ease: 'cubic', pose: add(over(STANCE, A_PAW), { hips: [22, 6, -3], spine01: [18, 1, -2], spine02: [19, 2, -2], chest: [20, 4, -5], neck: [11, 2, 0], head: [20, 2, -2], hip_L: [-24, 0, 4], knee_L: [40, 0, 0], hip_R: [-20, 0, -4], knee_R: [38, 0, 0], ankle_L: [-12, 0, 0], ankle_R: [-10, 0, 0] }), root: [0, -0.32, -0.09] },
  { t: 24, ease: 'cubic', pose: add(over(STANCE, L_KNEEL, A_PAW), { hips: [26, 6, -4], spine01: [20, 1, -3], spine02: [21, 2, -3], chest: [22, 4, -6], neck: [10, 2, 0], head: [22, 2, -3] }), root: [0, -0.46, -0.12] },
  { t: 36, ease: 'sine', pose: add(over(STANCE, L_KNEEL, A_PAW), { hips: [32, 5, -5], spine01: [24, 1, -4], spine02: [25, 2, -4], chest: [26, 3, -8], neck: [12, 2, 0], head: [26, 1, -4], shoulder_L: [-14, 0, 0], shoulder_R: [-12, 0, 0], elbow_L: [16, 0, 0], elbow_R: [16, 0, 0] }), root: [0, -0.51, -0.14] },
  { t: 46, ease: 'sine', pose: add(over(STANCE, L_KNEEL, A_PAW), { hips: [35, 5, -6], spine01: [26, 1, -4], spine02: [27, 2, -5], chest: [29, 3, -9], neck: [14, 2, 0], head: [30, 1, -5], shoulder_L: [-18, 0, 0], shoulder_R: [-16, 0, 0], elbow_L: [22, 0, 0], elbow_R: [22, 0, 0] }), root: [0, -0.535, -0.15] },
  { t: 54, pose: add(over(STANCE, L_KNEEL, A_PAW), { hips: [36, 5, -6], spine01: [27, 1, -4], spine02: [28, 2, -5], chest: [30, 3, -9], neck: [15, 2, 0], head: [32, 1, -5], shoulder_L: [-19, 0, 0], shoulder_R: [-17, 0, 0], elbow_L: [23, 0, 0], elbow_R: [23, 0, 0] }), root: [0, -0.54, -0.15] },
]);
...
const getUp = makeClip('r.getUp', { duration: 50, blendIn: 6, blendOut: 8 }, [
  ...
  { t: 28, ease: 'cubic', pose: add(over(STANCE, L_KNEEL, A_POST), { hips: [16, -6, 2], spine01: [2, 1, 1], spine02: [2, 1, 1], chest: [3, 2, 0], neck: [-2, 1, 0], head: [-4, 2, 0], shoulder_R: [-24, 0, -8], elbow_R: [-30, 0, 0] }), root: [0, -0.45, -0.02] },
...
const getUpRoll = makeClip('r.getUpRoll', { duration: 42, blendIn: 5, blendOut: 6 }, [
  ...
  { t: 21, ease: 'quad', pose: add(over(STANCE, L_ALLFOUR, A_POST), { hips: [64, -10, 0], spine01: [-8, 1, 0], spine02: [-8, 1, 0], chest: [-10, 2, 0], neck: [-14, 1, 0], head: [-22, 2, 0] }), root: [0, -0.48, -0.6] },
...
const koSlump = makeClip('r.koSlump', { duration: 70, blendIn: 2, blendOut: 12 }, [
  ...
  { t: 18, ease: 'quad', pose: add(over(STANCE, A_PAW), { hips: [20, 5, -2], spine01: [16, 1, -1], spine02: [17, 1, -2], chest: [19, 3, -5], neck: [10, 2, 0], head: [22, 2, -3], hip_L: [-26, 0, 3], knee_L: [44, 0, 0], hip_R: [-22, 0, -3], knee_R: [42, 0, 0], ankle_L: [-14, 0, 0] }), root: [0, -0.35, -0.06] },
  { t: 28, ease: 'quad', pose: add(over(STANCE, L_KNEEL, A_PAW), { hips: [28, 5, -4], spine01: [20, 1, -3], spine02: [21, 2, -3], chest: [23, 3, -7], neck: [11, 2, 0], head: [24, 1, -4] }), root: [0, -0.46, -0.08] },
  { t: 38, ease: 'quad', pose: add(over(STANCE, L_KNEEL, A_LIMP), { hips: [56, 4, -4], spine01: [16, 1, -2], spine02: [17, 1, -3], chest: [18, 2, -6], neck: [-4, 1, 0], head: [-8, 1, -3], shoulder_L: [-30, 0, 0], shoulder_R: [-28, 0, 0] }), root: [0, -0.6, 0.06] },
