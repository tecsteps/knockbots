...
export const PUNCH_CLIPS = {
  ...
  'p.jab': {
    ...
    root: [
      ...
      { t: 10, p: [0, -0.014, 0.09], ease: 'sine' },
      { t: 12, p: [0, -0.004, 0.1], ease: 'quad' },
    ...
    tracks: {
      ...
      ankle_L: [{ t: 0, r: [-4, 2, 0], ease: 'quad' }, { t: 6, r: [-32.5, 2, 0], ease: 'quart' },
        { t: 10, r: [-16.6, 2, 0], ease: 'sine' }, { t: 12, r: [-14.85, 2, 0], ease: 'quad' },
        { t: 16, r: [-4, 2, 0], ease: 'sine' }, { t: 20, r: [-2.61, 2, 0], ease: 'sine' }, { t: 24, r: [-4, 2, 0], ease: 'linear' }],
      ...
      ankle_R: [{ t: 0, r: [-33, -3, 0], ease: 'quad' }, { t: 6, r: [-49.5, -3, 0], ease: 'quart' },
        { t: 10, r: [-8, 0, 0], ease: 'sine' }, { t: 12, r: [-4.5, 0.33, 0], ease: 'quad' },
        { t: 16, r: [-33, -3, 0], ease: 'sine' }, { t: 20, r: [-35.75, -3.33, 0], ease: 'sine' }, { t: 24, r: [-33, -3, 0], ease: 'linear' }],
    },
  },
  ...
  'p.jabAlt': {
    ...
    root: [
      ...
      { t: 9, p: [0, -0.017, 0.14], ease: 'sine' },
      { t: 11, p: [0, -0.008, 0.153], ease: 'quad' },
    ...
    tracks: {
      ...
      ankle_L: [{ t: 0, r: [-4, 2, 0], ease: 'quad' }, { t: 5, r: [-27.1, 2, 0], ease: 'quart' },
        { t: 9, r: [-16.7, 2, 0], ease: 'sine' }, { t: 11, r: [-15.56, 2, 0], ease: 'quad' },
        { t: 15, r: [-4, 2, 0], ease: 'sine' }, { t: 18, r: [-2.6, 2, 0], ease: 'sine' }, { t: 22, r: [-4, 2, 0], ease: 'linear' }],
      ...
      ankle_R: [{ t: 0, r: [-33, -3, 0], ease: 'quad' }, { t: 5, r: [-44.1, -3, 0], ease: 'quart' },
        { t: 9, r: [-8, 0, 0], ease: 'sine' }, { t: 11, r: [-4.5, 0.33, 0], ease: 'quad' },
        { t: 15, r: [-33, -3, 0], ease: 'sine' }, { t: 18, r: [-35.75, -3.33, 0], ease: 'sine' }, { t: 22, r: [-33, -3, 0], ease: 'linear' }],
    },
  },
  ...
  'p.straight': {
    ...
    root: [
      ...
      { t: 14, p: [0, -0.097, 0.18], ease: 'sine' },
      { t: 17, p: [0, -0.108, 0.193], ease: 'quad' },
    ...
    tracks: {
      ...
      ankle_L: [{ t: 0, r: [-4, 2, 0], ease: 'quad' }, { t: 7, r: [-39.5, 2, 0], ease: 'sine' },
        { t: 11, r: [-20.7, 2, 0], ease: 'quart' }, { t: 14, r: [-11.1, 2, 0], ease: 'sine' },
        { t: 17, r: [-10.04, 2, 0], ease: 'quad' }, { t: 23, r: [-19.7, 2, 0], ease: 'sine' },
      ...
      ankle_R: [{ t: 0, r: [-33, -3, 0], ease: 'quad' }, { t: 7, r: [-49, -3, 0], ease: 'sine' },
        { t: 11, r: [-4, 0, 0], ease: 'quart' }, { t: 14, r: [-34, 0, 0], ease: 'sine' },
        { t: 17, r: [-37.3, 0, 0], ease: 'quad' }, { t: 23, r: [-22, 0, 0], ease: 'sine' },
  ...
  'p.hook': {
    ...
    root: [
      ...
      { t: 15, p: [0, -0.084, 0.12], ease: 'sine' },
      { t: 18, p: [0, -0.093, 0.128], ease: 'quad' },
    ...
    tracks: {
      ...
      ankle_L: [{ t: 0, r: [-4, 2, 0], ease: 'quad' }, { t: 8, r: [-31.8, 2, 0], ease: 'sine' },
        { t: 12, r: [-23.5, 2, 0], ease: 'quart' }, { t: 15, r: [-14.3, 2, 0], ease: 'sine' },
        { t: 18, r: [-13.29, 2, 0], ease: 'quad' }, { t: 23, r: [-18.4, 2, 0], ease: 'sine' },
        { t: 32, r: [-4, 2, 0], ease: 'linear' }],
      ...
      ankle_R: [{ t: 0, r: [-33, -3, 0], ease: 'quad' }, { t: 8, r: [-47.4, -3, 0], ease: 'sine' },
        { t: 12, r: [-10, 0, 0], ease: 'quart' }, { t: 15, r: [-30, 0, 0], ease: 'sine' },
        { t: 18, r: [-32.2, 0, 0], ease: 'quad' }, { t: 23, r: [-28, 0, 0], ease: 'sine' },
        { t: 32, r: [-33, -3, 0], ease: 'linear' }],
    },
  },
  ...
  'p.uppercut': {
    ...
    root: [
      ...
      { t: 16, p: [0, -0.082, 0.14], ease: 'sine' },
      { t: 19, p: [0, -0.09, 0.147], ease: 'quad' },
    ...
    tracks: {
      ...
      ankle_L: [{ t: 0, r: [-4, 2, 0], ease: 'quad' }, { t: 9, r: [-47.9, 2, 0], ease: 'sine' },
        { t: 13, r: [-22.4, 2, 0], ease: 'quart' }, { t: 16, r: [-11.5, 2, 0], ease: 'sine' },
        { t: 19, r: [-10.3, 2, 0], ease: 'quad' }, { t: 26, r: [-26.6, 2, 0], ease: 'sine' },
      ...
      ankle_R: [{ t: 0, r: [-33, -3, 0], ease: 'quad' }, { t: 9, r: [-57.1, -3, 0], ease: 'sine' },
        { t: 13, r: [-14, 0, 0], ease: 'quart' }, { t: 16, r: [-40, 0, 0], ease: 'sine' },
        { t: 19, r: [-42.86, 0, 0], ease: 'quad' }, { t: 26, r: [-18, 0, 0], ease: 'sine' },
  ...
  'p.overhand': {
    ...
    tracks: {
      ...
      ankle_L: [{ t: 0, r: [-4, 2, 0], ease: 'quad' }, { t: 10, r: [-39, 2, 0], ease: 'sine' },
        { t: 15, r: [-21.8, 2, 0], ease: 'sine' }, { t: 18, r: [-15.8, 2, 0], ease: 'sine' },
        { t: 22, r: [-15.14, 2, 0], ease: 'quad' }, { t: 29, r: [-20.6, 2, 0], ease: 'sine' },
      ...
      ankle_R: [{ t: 0, r: [-33, -3, 0], ease: 'quad' }, { t: 10, r: [-48.2, -3, 0], ease: 'sine' },
        { t: 15, r: [-12, 0, 0], ease: 'sine' }, { t: 18, r: [-44, 0, 0], ease: 'sine' },
        { t: 22, r: [-47.5, 0, 0], ease: 'quad' }, { t: 29, r: [-26, 0, 0], ease: 'sine' },
  ...
  'p.elbow': {
    ...
    tracks: {
      ...
      ankle_L: [{ t: 0, r: [-4, 2, 0], ease: 'quad' }, { t: 8, r: [-39.4, 2, 0], ease: 'quart' },
        { t: 14, r: [-12.4, 2, 0], ease: 'sine' }, { t: 17, r: [-9.43, 2, 0], ease: 'quad' },
        { t: 22, r: [-4, 2, 0], ease: 'sine' }, { t: 25, r: [-3.08, 2, 0], ease: 'sine' }, { t: 28, r: [-4, 2, 0], ease: 'linear' }],
      ...
      ankle_R: [{ t: 0, r: [-33, -3, 0], ease: 'quad' }, { t: 8, r: [-48.8, -3, 0], ease: 'quart' },
        { t: 14, r: [-36, 0, 0], ease: 'sine' }, { t: 17, r: [-34.59, 0.33, 0], ease: 'quad' },
        { t: 22, r: [-33, -3, 0], ease: 'sine' }, { t: 25, r: [-32.67, -3.33, 0], ease: 'sine' }, { t: 28, r: [-33, -3, 0], ease: 'linear' }],
    },
  },
  ...
  'p.backfist': {
    ...
    root: [
      ...
      { t: 16, p: [0, -0.031, 0.1], ry: -276, ease: 'sine' },
      { t: 19, p: [0, -0.024, 0.109], ry: -280, ease: 'quad' },
      { t: 26, p: [0, -0.071, 0.06], ry: -360, ease: 'sine' },
    ...
    tracks: {
      ...
      knee_L: [{ t: 0, r: [42, 0, 0], ease: 'quad' }, { t: 6, r: [34, 0, 0], ease: 'sine' },
        ...
        { t: 36, r: [42, 0, 0], ease: 'linear' }],
      ankle_L: [{ t: 0, r: [-4, 2, 0], ease: 'quad' }, { t: 6, r: [-34.2, 2, 0], ease: 'sine' },
        { t: 12, r: [-35.7, 2, 0], ease: 'quart' }, { t: 16, r: [-26.2, 2, 0], ease: 'sine' },
        { t: 19, r: [-25.15, 2, 0], ease: 'quad' }, { t: 26, r: [-4, 2, 0], ease: 'sine' }, { t: 31, r: [-1.56, 2, 0], ease: 'sine' },
        { t: 36, r: [-4, 2, 0], ease: 'linear' }],
      ...
      knee_R: [{ t: 0, r: [45, 0, 0], ease: 'quad' }, { t: 6, r: [28, 0, 0], ease: 'sine' },
        ...
        { t: 36, r: [45, 0, 0], ease: 'linear' }],
      ankle_R: [{ t: 0, r: [-33, -3, 0], ease: 'quad' }, { t: 6, r: [-47.3, -3, 0], ease: 'sine' },
        { t: 12, r: [-43.3, -3, 0], ease: 'quart' }, { t: 16, r: [-18, 0, 0], ease: 'sine' },
        { t: 19, r: [-15.22, 0.33, 0], ease: 'quad' }, { t: 26, r: [-33, -3, 0], ease: 'sine' }, { t: 31, r: [-34.65, -3.33, 0], ease: 'sine' },
        { t: 36, r: [-33, -3, 0], ease: 'linear' }],
    },
  },
  ...
  'p.hammerFist': {
    ...
    tracks: {
      ...
      ankle_L: [{ t: 0, r: [-4, 2, 0], ease: 'quad' }, { t: 9, r: [-20.6, 2, 0], ease: 'sine' },
        { t: 14, r: [-17.9, 2, 0], ease: 'sine' }, { t: 19, r: [-35.6, 2, 0], ease: 'sine' },
        { t: 23, r: [-37.55, 2, 0], ease: 'quad' }, { t: 30, r: [-31.8, 2, 0], ease: 'sine' },
      ...
      ankle_R: [{ t: 0, r: [-33, -3, 0], ease: 'quad' }, { t: 9, r: [-35.4, -3, 0], ease: 'sine' },
        { t: 14, r: [-28.9, -3, 0], ease: 'sine' }, { t: 19, r: [-58.4, -3, 0], ease: 'sine' },
        { t: 23, r: [-61.64, -3, 0], ease: 'quad' }, { t: 30, r: [-52.6, -3, 0], ease: 'sine' },
  ...
  'p.pistonRush': {
    ...
    root: [
      ...
      { t: 36, p: [0, -0.077, 0.52], ease: 'sine' },
      { t: 40, p: [0, -0.074, 0.529], ease: 'sine' },
    ...
    tracks: {
      ...
      ankle_L: [{ t: 0, r: [-4, 2, 0], ease: 'quart' }, { t: 12, r: [-19.2, 2, 0], ease: 'quad' },
        ...
        { t: 32, r: [-27.2, 2, 0], ease: 'quart' }, { t: 36, r: [-14.2, 2, 0], ease: 'sine' },
        { t: 40, r: [-12.77, 2, 0], ease: 'sine' }, { t: 50, r: [-27.1, 2, 0], ease: 'sine' },
      ...
      ankle_R: [{ t: 0, r: [-33, -3, 0], ease: 'quart' }, { t: 12, r: [-14, 0, 0], ease: 'quad' },
        ...
        { t: 32, r: [-44.1, -3, 0], ease: 'quart' }, { t: 36, r: [-30, 0, 0], ease: 'sine' },
        { t: 40, r: [-28.45, 0.33, 0], ease: 'sine' }, { t: 50, r: [-44, -3, 0], ease: 'sine' },
  ...
  'p.launcherPunch': {
    ...
    root: [
      ...
      { t: 12, p: [0, -0.203, -0.1], ease: 'sine' },
      { t: 14, p: [0, -0.076, 0.16], ease: 'quad' },
      { t: 17, p: [0, -0.065, 0.18], ease: 'sine' },
      { t: 21, p: [0, -0.064, 0.182], ease: 'quad' },
      { t: 29, p: [0, -0.041, 0.1], ease: 'sine' },
    ...
    tracks: {
      ...
      ankle_L: [{ t: 0, r: [-4, 2, 0], ease: 'sine' }, { t: 6, r: [-42, 2, 0], ease: 'sine' },
        { t: 12, r: [-60.9, 2, 0], ease: 'sine' }, { t: 14, r: [-10.2, 2, 0], ease: 'quad' },
        { t: 17, r: [-11.2, 2, 0], ease: 'sine' }, { t: 21, r: [-11.31, 2, 0], ease: 'quad' },
        { t: 29, r: [-31.2, 2, 0], ease: 'sine' }, { t: 43, r: [-4, 2, 0], ease: 'linear' }],
      ...
      ankle_R: [{ t: 0, r: [-33, -3, 0], ease: 'sine' }, { t: 6, r: [-53.1, -3, 0], ease: 'sine' },
        { t: 12, r: [-60.5, -3, 0], ease: 'sine' }, { t: 14, r: [-48, 0, 0], ease: 'quad' },
        { t: 17, r: [-52, 0, 0], ease: 'sine' }, { t: 21, r: [-52.44, 0, 0], ease: 'quad' },
        { t: 29, r: [-20, 0, 0], ease: 'sine' }, { t: 43, r: [-33, -3, 0], ease: 'linear' }],
    },
  },
  ...
  'p.lowJab': {
    ...
    root: [
      ...
      { t: 11, p: [0, -0.099, 0.1], ease: 'sine' },
      { t: 13, p: [0, -0.091, 0.111], ease: 'quad' },
    ...
    tracks: {
      ...
      ankle_L: [{ t: 0, r: [-4, 2, 0], ease: 'quad' }, { t: 7, r: [-52, 2, 0], ease: 'quart' },
        { t: 11, r: [-42.4, 2, 0], ease: 'sine' }, { t: 13, r: [-41.34, 2, 0], ease: 'quad' },
      ...
      ankle_R: [{ t: 0, r: [-33, -3, 0], ease: 'quad' }, { t: 7, r: [-62, -3, 0], ease: 'quart' },
        { t: 11, r: [-14, 0, 0], ease: 'sine' }, { t: 13, r: [-10.5, 0.33, 0], ease: 'quad' },
  ...
  'p.duckingStraight': {
    ...
    root: [
      ...
      { t: 19, p: [0, -0.107, 0.233], ease: 'quad' },
    ...
    tracks: {
      ...
      ankle_L: [{ t: 0, r: [-4, 2, 0], ease: 'sine' }, { t: 9, r: [-62, 2, 0], ease: 'sine' },
        { t: 13, r: [-44.9, 2, 0], ease: 'quart' }, { t: 16, r: [-17.5, 2, 0], ease: 'sine' },
        { t: 19, r: [-14.49, 2, 0], ease: 'quad' }, { t: 26, r: [-25.4, 2, 0], ease: 'sine' },
      ...
      ankle_R: [{ t: 0, r: [-33, -3, 0], ease: 'sine' }, { t: 9, r: [-62, -3, 0], ease: 'sine' },
        { t: 13, r: [-10, 0, 0], ease: 'quart' }, { t: 16, r: [-36, 0, 0], ease: 'sine' },
        { t: 19, r: [-38.86, 0, 0], ease: 'quad' }, { t: 26, r: [-20, 0, 0], ease: 'sine' },
