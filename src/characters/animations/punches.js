...
export const PUNCH_CLIPS = {
  ...
  'p.overhand': {
    ...
    root: [
      { t: 0, p: [0, -0.075, 0], ease: 'quad' },
      { t: 12.22, p: [0, -0.118, -0.04], ease: 'sine' },
      { t: 18.33, p: [0, -0.104, 0.08], ease: 'sine' },
    ...
    tracks: {
      hips: [{ t: 0, r: [1, -27.8, 0], ease: 'quad' }, { t: 12.22, r: [0.5, -36, 1.5], ease: 'sine' },
        { t: 18.33, r: [0, -17.4, 0.6], ease: 'sine' }, { t: 22, r: [3.6, 5.8, 1.8], ease: 'sine' },
        { t: 26, r: [4, 8.35, 1.93], ease: 'quad' }, { t: 33, r: [2.9, -5.8, 0.9], ease: 'sine' },
        { t: 44, r: [1, -27.8, 0], ease: 'linear' }],
      spine01: [{ t: 0, r: [1.9, 5.2, 0], ease: 'quad' }, { t: 12.22, r: [1, 5.9, 2.5], ease: 'sine' },
        { t: 18.33, r: [0, 4.4, 1], ease: 'sine' }, { t: 22, r: [7.2, 2.6, 3], ease: 'sine' },
        { t: 26, r: [7.99, 2.4, 3.22], ease: 'quad' }, { t: 33, r: [5.8, 3.5, 1.5], ease: 'sine' },
        { t: 44, r: [1.9, 5.2, 0], ease: 'linear' }],
      spine02: [{ t: 0, r: [2.6, 6.1, 0], ease: 'quad' }, { t: 12.22, r: [1.3, 6.9, 2.8], ease: 'sine' },
        { t: 18.33, r: [0, 5.2, 1.1], ease: 'sine' }, { t: 22, r: [9.6, 3.1, 3.4], ease: 'sine' },
        { t: 26, r: [10.66, 2.87, 3.65], ease: 'quad' }, { t: 33, r: [7.7, 4.2, 1.7], ease: 'sine' },
        { t: 44, r: [2.6, 6.1, 0], ease: 'linear' }],
      chest: [{ t: 0, r: [2.6, 7.3, -3], ease: 'quad' }, { t: 12.22, r: [1.3, 8.2, 0.2], ease: 'sine' },
        { t: 18.33, r: [0, 6.2, -1.7], ease: 'sine' }, { t: 22, r: [9.6, 3.7, 0.8], ease: 'sine' },
        { t: 26, r: [10.66, 3.43, 1.08], ease: 'quad' }, { t: 33, r: [7.7, 4.9, -1.1], ease: 'sine' },
      ...
      clavicle_R: [{ t: 0, r: [0, 8, 4] }],
      shoulder_R: [{ t: 0, r: [-22, 0, 36], ease: 'quad' }, { t: 12.22, r: [-120.1, 2, 199.5], ease: 'sine' },
        { t: 18.33, r: [-44.5, 35.2, 307.4], ease: 'sine' }, { t: 22, r: [-45.8, 30.7, 324.2], ease: 'expo' },
        { t: 26, r: [-47.07, 26.31, 340.58], ease: 'quad' }, { t: 33, r: [-48.3, -22.1, 356.4], ease: 'sine' },
        { t: 44, r: [-22, 0, 396], ease: 'linear' }],
      elbow_R: [{ t: 0, r: [-145, 0, -1], ease: 'quad' }, { t: 12.22, r: [-79, 0, -1], ease: 'sine' },
        { t: 18.33, r: [-39.2, 0, -1], ease: 'sine' }, { t: 22, r: [-14.5, 0, -1], ease: 'sine' },
        { t: 26, r: [-11.78, 0, -1], ease: 'quad' }, { t: 29, r: [-36.1, 0, -1], ease: 'quad' },
        { t: 33, r: [-86.5, 0, -1], ease: 'sine' }, { t: 44, r: [-145, 0, -1], ease: 'linear' }],
      wrist_R: [{ t: 0, r: [-8, 0, 0], ease: 'quad' }, { t: 12.22, r: [-8, 4, 0], ease: 'sine' },
        { t: 18.33, r: [-8, 10, 0], ease: 'sine' }, { t: 22, r: [-8, -32, 0], ease: 'sine' },
        { t: 26, r: [-8, -35.5, 0], ease: 'quad' }, { t: 29, r: [-8, -41, 0], ease: 'sine' },
        { t: 33, r: [-8, -10, 0], ease: 'sine' }, { t: 44, r: [-8, 0, 0], ease: 'linear' }],
      hand_R: [{ t: 0, r: [-14, 0, 0], ease: 'quad' }, { t: 12.22, r: [-18.8, 0, 2.8], ease: 'sine' },
        { t: 18.33, r: [-26, 0, 7], ease: 'sine' }, { t: 22, r: [-2, 0, -2], ease: 'sine' },
        { t: 26, r: [0.64, 0, -2.99], ease: 'quad' }, { t: 29, r: [-28, 0, -10], ease: 'sine' },
  ...
  'p.backfist': {
    ...
    root: [
      ...
      { t: 9.75, p: [0, -0.096, 0.02], ry: -150, ease: 'quart' },
    ...
    tracks: {
      hips: [{ t: 0, r: [1, -27.8, 0], ease: 'quad' }, { t: 4.88, r: [1.2, -13.9, 0], ease: 'sine' },
        { t: 9.75, r: [1, 0, 0], ease: 'quart' }, { t: 13, r: [0.7, -8.1, -0.9], ease: 'sine' },
        { t: 16, r: [0.67, -8.99, -1], ease: 'quad' }, { t: 23, r: [1.4, -23.2, 0], ease: 'sine' },
        { t: 33, r: [1, -27.8, 0], ease: 'linear' }],
      spine01: [{ t: 0, r: [1.9, 5.2, 0], ease: 'quad' }, { t: 4.88, r: [2.4, 4.2, 0], ease: 'sine' },
        { t: 9.75, r: [1.9, 3.1, 0], ease: 'quart' }, { t: 13, r: [1.4, 3.7, -1.5], ease: 'sine' },
        { t: 16, r: [1.35, 3.77, -1.66], ease: 'quad' }, { t: 23, r: [2.9, 4.9, 0], ease: 'sine' },
        { t: 33, r: [1.9, 5.2, 0], ease: 'linear' }],
      spine02: [{ t: 0, r: [2.6, 6.1, 0], ease: 'quad' }, { t: 4.88, r: [3.2, 4.9, 0], ease: 'sine' },
        { t: 9.75, r: [2.6, 3.6, 0], ease: 'quart' }, { t: 13, r: [1.9, 4.4, -1.7], ease: 'sine' },
        { t: 16, r: [1.82, 4.49, -1.89], ease: 'quad' }, { t: 23, r: [3.8, 5.7, 0], ease: 'sine' },
        { t: 33, r: [2.6, 6.1, 0], ease: 'linear' }],
      chest: [{ t: 0, r: [2.6, 7.3, -3], ease: 'quad' }, { t: 4.88, r: [3.2, 5.8, -3], ease: 'sine' },
        { t: 9.75, r: [2.6, 4.3, -3], ease: 'quart' }, { t: 13, r: [1.9, 5.2, -4.9], ease: 'sine' },
        { t: 16, r: [1.82, 5.3, -5.11], ease: 'quad' }, { t: 23, r: [3.8, 6.8, -3], ease: 'sine' },
      ...
      clavicle_L: [{ t: 0, r: [0, -10, -4] }],
      shoulder_L: [{ t: 0, r: [-35, 0, -36], ease: 'quad' }, { t: 4.88, r: [4, -27, -22.8], ease: 'sine' },
        { t: 9.75, r: [182, 5.7, -71.7], ease: 'quart' }, { t: 13, r: [270, 5, -17], ease: 'sine' },
        { t: 16, r: [273.5, 4.92, -13.5], ease: 'quad' }, { t: 19, r: [298.1, 5.4, -2.3], ease: 'quad' },
        { t: 23, r: [336.1, 10.8, -2.4], ease: 'sine' }, { t: 33, r: [325, 0, -36], ease: 'linear' }],
      elbow_L: [{ t: 0, r: [-124, 0, 17], ease: 'quad' }, { t: 4.88, r: [-152, 0, 17], ease: 'sine' },
        { t: 9.75, r: [-102.9, 0, 17], ease: 'quart' }, { t: 13, r: [-8.8, 0, 17], ease: 'sine' },
        { t: 16, r: [-5.3, 0, 17], ease: 'quad' }, { t: 19, r: [-37.2, 0, 17], ease: 'quad' },
        { t: 23, r: [-103.6, 0, 17], ease: 'sine' }, { t: 33, r: [-124, 0, 17], ease: 'linear' }],
      wrist_L: [{ t: 0, r: [-8, 0, 0], ease: 'quad' }, { t: 4.88, r: [-8, -4, 0], ease: 'sine' },
        { t: 9.75, r: [-8, -10, 0], ease: 'quart' }, { t: 13, r: [-8, 32, 0], ease: 'sine' },
        { t: 16, r: [-8, 35.5, 0], ease: 'quad' }, { t: 19, r: [-8, 41, 0], ease: 'sine' },
        { t: 23, r: [-8, 10, 0], ease: 'sine' }, { t: 33, r: [-8, 0, 0], ease: 'linear' }],
      hand_L: [{ t: 0, r: [-14, 0, 0], ease: 'quad' }, { t: 4.88, r: [-18.8, 0, -2.8], ease: 'sine' },
        { t: 9.75, r: [-26, 0, -7], ease: 'quart' }, { t: 13, r: [-2, 0, 2], ease: 'sine' },
        { t: 16, r: [0.64, 0, 2.99], ease: 'quad' }, { t: 19, r: [-28, 0, 10], ease: 'sine' },
        { t: 23, r: [-18, 0, 0], ease: 'sine' }, { t: 33, r: [-14, 0, 0], ease: 'linear' }],
      clavicle_R: [{ t: 0, r: [0, 8, 4] }],
  ...
  'p.siegeSlam': {
    ...
    tracks: {
      hips: [{ t: 0, r: [1, -27.8, 0], ease: 'quad' }, { t: 10, r: [4.5, -21, 0], ease: 'sine' }, { t: 18, r: [-2, -8, 0], ease: 'sine' },
        { t: 32, r: [-11, -5, 0], ease: 'quart' }, { t: 40, r: [-14.5, -4, 0], ease: 'quad' }, { t: 44, r: [-9, -5, 0], ease: 'quad' },
        { t: 46, r: [0, -8, 0], ease: 'sine' }, { t: 48, r: [16, -12, 0], ease: 'sine' }, { t: 52, r: [18.4, -12.6, 0], ease: 'quad' },
        { t: 56, r: [16, -13.5, 0], ease: 'sine' }, { t: 60, r: [13, -15, 0], ease: 'sine' }, { t: 72, r: [6, -20, 0], ease: 'linear' },
        { t: 86, r: [1, -27.8, 0] }],
      spine01: [{ t: 0, r: [1.9, 5.2, 0], ease: 'quad' }, { t: 10, r: [5.5, 5, 0], ease: 'sine' }, { t: 18, r: [0, 3, 0], ease: 'sine' },
        { t: 32, r: [-8, 2, 0], ease: 'quart' }, { t: 40, r: [-11, 1.5, 0], ease: 'quad' }, { t: 44, r: [-6, 1.8, 0], ease: 'quad' },
        { t: 46, r: [2, 2.4, 0], ease: 'sine' }, { t: 48, r: [15, 3.4, 0], ease: 'sine' }, { t: 52, r: [17.2, 3.5, 0], ease: 'quad' },
        { t: 56, r: [15, 3.6, 0], ease: 'sine' }, { t: 60, r: [12, 3.8, 0], ease: 'sine' }, { t: 72, r: [5.5, 4.4, 0], ease: 'linear' },
        { t: 86, r: [1.9, 5.2, 0] }],
      spine02: [{ t: 0, r: [2.6, 6.1, 0], ease: 'quad' }, { t: 10, r: [7.4, 5.9, 0], ease: 'sine' }, { t: 18, r: [0, 3.6, 0], ease: 'sine' },
        { t: 32, r: [-10.5, 2.4, 0], ease: 'quart' }, { t: 40, r: [-14.5, 1.8, 0], ease: 'quad' }, { t: 44, r: [-8, 2.2, 0], ease: 'quad' },
        { t: 46, r: [3, 2.9, 0], ease: 'sine' }, { t: 48, r: [20, 4, 0], ease: 'sine' }, { t: 52, r: [23, 4.1, 0], ease: 'quad' },
        { t: 56, r: [20, 4.2, 0], ease: 'sine' }, { t: 60, r: [16, 4.5, 0], ease: 'sine' }, { t: 72, r: [7.4, 5.2, 0], ease: 'linear' },
        { t: 86, r: [2.6, 6.1, 0] }],
      chest: [{ t: 0, r: [2.6, 7.3, -3], ease: 'quad' }, { t: 10, r: [7.4, 6.4, -3], ease: 'sine' }, { t: 18, r: [0, 2.5, -1], ease: 'sine' },
        { t: 32, r: [-10.5, 1.5, 0], ease: 'quart' }, { t: 40, r: [-14.5, 1, 0], ease: 'quad' }, { t: 44, r: [-8, 1.4, -0.4], ease: 'quad' },
        { t: 46, r: [3, 2, -1.2], ease: 'sine' }, { t: 48, r: [20, 3, -2], ease: 'sine' }, { t: 52, r: [23, 3.1, -2.2], ease: 'quad' },
        { t: 56, r: [20, 3.4, -2.3], ease: 'sine' }, { t: 60, r: [16, 3.8, -2.4], ease: 'sine' }, { t: 72, r: [7.4, 5.4, -2.8], ease: 'linear' },
        { t: 86, r: [2.6, 7.3, -3] }],
      ...
      clavicle_R: [{ t: 0, r: [0, 8, 4], ease: 'quad' }, { t: 10, r: [0, 6, 8], ease: 'sine' }, { t: 18, r: [0, 5, 12], ease: 'sine' },
        ...
        { t: 86, r: [0, 8, 4] }],
      shoulder_R: [{ t: 0, r: [-22, 0, 36], ease: 'quad' }, { t: 10, r: [-58, 8, -18], ease: 'sine' }, { t: 18, r: [-84, 13, -50], ease: 'sine' },
        { t: 32, r: [-88, 14, -53], ease: 'quart' }, { t: 40, r: [-92, 14, -57], ease: 'quad' }, { t: 44, r: [-86, 20, -62], ease: 'quad' },
        { t: 46, r: [-52, 38, -68], ease: 'sine' }, { t: 48, r: [-21.8, 53, -66], ease: 'sine' }, { t: 52, r: [-7.1, 61.3, -68], ease: 'quad' },
        { t: 56, r: [-8.3, 54.5, -60.7], ease: 'sine' }, { t: 60, r: [-40, 20, -20], ease: 'sine' }, { t: 72, r: [-56, -20, 10], ease: 'linear' },
        { t: 86, r: [-22, 0, 36] }],
      elbow_R: [{ t: 0, r: [-145, 0, -1], ease: 'quad' }, { t: 10, r: [-80, 0, -1], ease: 'sine' }, { t: 18, r: [-34, 0, -1], ease: 'sine' },
        { t: 32, r: [-24, 0, -1], ease: 'quart' }, { t: 40, r: [-20, 0, -1], ease: 'quad' }, { t: 44, r: [-22, 0, -1], ease: 'quad' },
        { t: 46, r: [-23, 0, -1], ease: 'sine' }, { t: 48, r: [-23.3, 0, -1], ease: 'sine' }, { t: 52, r: [-23.5, 0, -1], ease: 'quad' },
        { t: 56, r: [-44, 0, -1], ease: 'sine' }, { t: 60, r: [-70, 0, -1], ease: 'sine' }, { t: 72, r: [-110, 0, -1], ease: 'linear' },
        { t: 86, r: [-145, 0, -1] }],
      wrist_R: [{ t: 0, r: [-8, 0, 0], ease: 'quad' }, { t: 10, r: [-8, 6, 0], ease: 'sine' }, { t: 18, r: [-8, 12, 0], ease: 'sine' },
        { t: 32, r: [-8, 19, 0], ease: 'quart' }, { t: 40, r: [-8, 22, 0], ease: 'quad' }, { t: 44, r: [-8, 16, 0], ease: 'quad' },
        { t: 46, r: [-8, -4, 0], ease: 'sine' }, { t: 48, r: [-8, -32, 0], ease: 'sine' }, { t: 52, r: [-8, -35.5, 0], ease: 'quad' },
        { t: 56, r: [-8, -41, 0], ease: 'sine' }, { t: 60, r: [-8, -14, 0], ease: 'sine' }, { t: 72, r: [-8, -4, 0], ease: 'linear' },
        { t: 86, r: [-8, 0, 0] }],
      hand_R: [{ t: 0, r: [-14, 0, 0], ease: 'quad' }, { t: 10, r: [-19, 0, 3], ease: 'sine' }, { t: 18, r: [-24, 0, 6], ease: 'sine' },
        { t: 32, r: [-30, 0, 9], ease: 'quart' }, { t: 40, r: [-32, 0, 10], ease: 'quad' }, { t: 44, r: [-28, 0, 8], ease: 'quad' },
        { t: 46, r: [-16, 0, 3], ease: 'sine' }, { t: 48, r: [-2, 0, -2], ease: 'sine' }, { t: 52, r: [0.6, 0, -3], ease: 'quad' },
        { t: 56, r: [-28, 0, -10], ease: 'sine' }, { t: 60, r: [-20, 0, -3], ease: 'sine' }, { t: 72, r: [-16, 0, -1], ease: 'linear' },
        { t: 86, r: [-14, 0, 0] }],
