...
export const KICK_CLIPS = {
  ...
  'k.spinKick': {
    ...
    root: [
      ...
      { t: 13.82, p: [0, -0.095, 0.04], ry: -160, ease: 'sine' },
    ...
    tracks: {
      hips: [{ t: 0, r: [1, -27.8, 0], ease: 'sine' }, { t: 7.77, r: [1, -17.4, 0], ease: 'sine' },
        { t: 13.82, r: [0.7, 2.3, 0], ease: 'sine' }, { t: 19, r: [0.5, -3.5, -2.1], ease: 'sine' },
        { t: 23, r: [0.48, -4.14, -2.33], ease: 'quad' }, { t: 31, r: [1.7, -22, 0], ease: 'sine' },
        { t: 45, r: [1, -27.8, 0], ease: 'linear' }],
      spine01: [{ t: 0, r: [1.9, 5.2, 0], ease: 'sine' }, { t: 7.77, r: [1.9, 4.4, 0], ease: 'sine' },
        { t: 13.82, r: [1.4, 2.9, 0], ease: 'sine' }, { t: 19, r: [1, 3.3, -3.5], ease: 'sine' },
        { t: 23, r: [0.96, 3.34, -3.88], ease: 'quad' }, { t: 31, r: [3.4, 4.8, 0], ease: 'sine' },
        { t: 45, r: [1.9, 5.2, 0], ease: 'linear' }],
      spine02: [{ t: 0, r: [2.6, 6.1, 0], ease: 'sine' }, { t: 7.77, r: [2.6, 5.2, 0], ease: 'sine' },
        { t: 13.82, r: [1.9, 3.4, 0], ease: 'sine' }, { t: 19, r: [1.3, 3.9, -3.9], ease: 'sine' },
        { t: 23, r: [1.23, 3.96, -4.33], ease: 'quad' }, { t: 31, r: [4.5, 5.6, 0], ease: 'sine' },
        { t: 45, r: [2.6, 6.1, 0], ease: 'linear' }],
      chest: [{ t: 0, r: [2.6, 7.3, -3], ease: 'sine' }, { t: 7.77, r: [2.6, 6.2, -3], ease: 'sine' },
        { t: 13.82, r: [1.9, 4, -3], ease: 'sine' }, { t: 19, r: [1.3, 4.7, -7.5], ease: 'sine' },
        { t: 23, r: [1.23, 4.78, -7.99], ease: 'quad' }, { t: 31, r: [4.5, 6.7, -3], ease: 'sine' },
        { t: 45, r: [2.6, 7.3, -3], ease: 'linear' }],
      ...
      wrist_R: [{ t: 0, r: [-8, 0, 0] }],
      hand_R: [{ t: 0, r: [-14, 0, 0] }],
      hip_L: [{ t: 0, r: [-39, 10, 11], ease: 'sine' }, { t: 7.77, r: [-14, -18, 12], ease: 'sine' },
        { t: 13.82, r: [-18, -14, 10], ease: 'sine' }, { t: 19, r: [-14, -6, 8], ease: 'expo' },
        { t: 23, r: [-5.27, 11.46, 3.64], ease: 'quad' }, { t: 31, r: [-18, -14, 10], ease: 'sine' },
        { t: 45, r: [-39, 10, 11], ease: 'linear' }],
      knee_L: [{ t: 0, r: [42, 0, 0], ease: 'sine' }, { t: 7.77, r: [34, 0, 0], ease: 'sine' },
        { t: 13.82, r: [26, 0, 0], ease: 'sine' }, { t: 19, r: [14, 0, 0], ease: 'sine' },
        { t: 23, r: [12.68, 0, 0], ease: 'quad' }, { t: 31, r: [36, 0, 0], ease: 'sine' },
        { t: 45, r: [42, 0, 0], ease: 'linear' }],
      ankle_L: [{ t: 0, r: [-4, 2, 0], ease: 'sine' }, { t: 7.77, r: [-35.7, 2, 0], ease: 'sine' },
        { t: 13.82, r: [-24.5, 2, 0], ease: 'sine' }, { t: 19, r: [-16.8, 2, 0], ease: 'sine' },
        { t: 23, r: [-15.95, 2, 0], ease: 'quad' }, { t: 31, r: [-34.5, 2, 0], ease: 'sine' },
        { t: 45, r: [-4, 2, 0], ease: 'linear' }],
      foot_L: [{ t: 0, r: [0, 0, 0], ease: 'sine' }, { t: 7.77, r: [9.5, 0, 0], ease: 'sine' },
        { t: 13.82, r: [6.1, 0, 0], ease: 'sine' }, { t: 19, r: [3.8, 0, 0], ease: 'sine' },
        { t: 23, r: [3.55, 0, 0], ease: 'quad' }, { t: 31, r: [9.2, 0, 0], ease: 'sine' },
  ...
  'k.jumpKick': {
    ...
    tracks: {
      hips: [{ t: 0, r: [1, -27.8, 0], ease: 'quart' }, { t: 7.56, r: [3.1, -26.7, 0.3], ease: 'quart' },
        { t: 11.33, r: [0.5, -23.2, 0.3], ease: 'quad' }, { t: 15.11, r: [0.2, -11.6, -0.9], ease: 'quart' },
        { t: 17, r: [1.7, -2.3, -1.2], ease: 'sine' }, { t: 21, r: [1.87, -1.28, -1.23], ease: 'quad' },
        { t: 29, r: [2.4, -15.1, -0.3], ease: 'quad' }, { t: 35, r: [3.6, -24.4, 0], ease: 'sine' },
        { t: 45, r: [1, -27.8, 0], ease: 'linear' }],
      spine01: [{ t: 0, r: [1.9, 5.2, 0], ease: 'quart' }, { t: 7.56, r: [6.2, 5.1, 0.5], ease: 'quart' },
        { t: 11.33, r: [1, 4.9, 0.5], ease: 'quad' }, { t: 15.11, r: [0.5, 4, -1.5], ease: 'quart' },
        { t: 17, r: [3.4, 3.3, -2], ease: 'sine' }, { t: 21, r: [3.72, 3.22, -2.06], ease: 'quad' },
        { t: 29, r: [4.8, 4.2, -0.5], ease: 'quad' }, { t: 35, r: [7.2, 5, 0], ease: 'sine' },
        { t: 45, r: [1.9, 5.2, 0], ease: 'linear' }],
      spine02: [{ t: 0, r: [2.6, 6.1, 0], ease: 'quart' }, { t: 7.56, r: [8.3, 6.1, 0.6], ease: 'quart' },
        { t: 11.33, r: [1.3, 5.7, 0.6], ease: 'quad' }, { t: 15.11, r: [0.6, 4.7, -1.7], ease: 'quart' },
        { t: 17, r: [4.5, 3.8, -2.2], ease: 'sine' }, { t: 21, r: [4.93, 3.7, -2.26], ease: 'quad' },
        { t: 29, r: [6.4, 5, -0.6], ease: 'quad' }, { t: 35, r: [9.6, 5.8, 0], ease: 'sine' },
        { t: 45, r: [2.6, 6.1, 0], ease: 'linear' }],
      chest: [{ t: 0, r: [2.6, 7.3, -3], ease: 'quart' }, { t: 7.56, r: [8.3, 7.2, -2.4], ease: 'quart' },
        { t: 11.33, r: [1.3, 6.8, -2.4], ease: 'quad' }, { t: 15.11, r: [0.6, 5.5, -4.9], ease: 'quart' },
        { t: 17, r: [4.5, 4.5, -5.6], ease: 'sine' }, { t: 21, r: [4.93, 4.39, -5.68], ease: 'quad' },
        { t: 29, r: [6.4, 5.9, -3.6], ease: 'quad' }, { t: 35, r: [9.6, 6.9, -3], ease: 'sine' },
        { t: 45, r: [2.6, 7.3, -3], ease: 'linear' }],
      ...
      hip_R: [{ t: 0, r: [-9, -6, -12], ease: 'quart' }, { t: 7.56, r: [-10, 6, -15], ease: 'quart' },
  ...
  'k.diveKick': {
    ...
    root: [
      ...
      { t: 3, p: [0, 0.1, 0.02], ease: 'quart' },
      { t: 5, p: [0, 0.04, 0.09], ease: 'quad' },
    ...
    tracks: {
      hips: [{ t: 0, r: [-1, -27.8, 1], ease: 'quad' }, { t: 3, r: [-8, -24, 2], ease: 'quart' },
        { t: 5, r: [4, -22, 0], ease: 'quad' }, { t: 7, r: [16, -16, 0], ease: 'sine' },
      ...
      spine01: [{ t: 0, r: [-0.1, 5.2, 0], ease: 'quad' }, { t: 3, r: [-5, 4.5, 0], ease: 'quart' },
        { t: 5, r: [3, 4, 0], ease: 'quad' }, { t: 7, r: [9, 3, 0], ease: 'sine' },
      ...
      spine02: [{ t: 0, r: [0.6, 6.1, 0], ease: 'quad' }, { t: 3, r: [-4, 5, 0], ease: 'quart' },
        { t: 5, r: [4, 4.5, 0], ease: 'quad' }, { t: 7, r: [11, 3.5, 0], ease: 'sine' },
      ...
      chest: [{ t: 0, r: [-0.4, 5.3, -2], ease: 'quad' }, { t: 3, r: [-6, 4, -2], ease: 'quart' },
        { t: 5, r: [4, 4, -3], ease: 'quad' }, { t: 7, r: [11, 3, -4], ease: 'sine' },
      ...
      // on it.
      hip_R: [{ t: 0, r: [-31.3, -4.3, -12], ease: 'quad' }, { t: 3, r: [-68, -8, -13], ease: 'quart' },
        { t: 5, r: [-56, -14, -13], ease: 'snap' }, { t: 7, r: [-42, -18, -13], ease: 'sine' },
        { t: 9, r: [-47, -19, -13], ease: 'quad' }, { t: 13, r: [-46, -8, -13], ease: 'cubic' },
        { t: 19, r: [-32.3, 5, -12], ease: 'cubic' }, { t: 26, r: [-16, -4, -12], ease: 'sine' },
        { t: 34, r: [-9, -6, -12], ease: 'linear' }],
      knee_R: [{ t: 0, r: [74.8, 0, 0], ease: 'quad' }, { t: 3, r: [104, 0, 0], ease: 'quart' },
        { t: 5, r: [46, 0, 0], ease: 'snap' }, { t: 7, r: [2, 0, 0], ease: 'sine' },
        { t: 9, r: [-3, 0, 0], ease: 'quad' }, { t: 13, r: [58, 0, 0], ease: 'cubic' },
        { t: 19, r: [95.4, 0, 0], ease: 'cubic' }, { t: 26, r: [56, 0, 0], ease: 'sine' },
        { t: 34, r: [45, 0, 0], ease: 'linear' }],
      ankle_R: [{ t: 0, r: [-19.3, 1.4, 0], ease: 'quad' }, { t: 3, r: [-30, 1, 0], ease: 'quart' }, { t: 5, r: [-2, 0, 0], ease: 'snap' },
        { t: 7, r: [26, 0, 0], ease: 'sine' }, { t: 9, r: [32, 0, 0], ease: 'quad' }, { t: 13, r: [-24, 0, 0], ease: 'cubic' },
        { t: 19, r: [-58.4, -12.1, 0], ease: 'cubic' }, { t: 26, r: [-32.1, -3, 0], ease: 'sine' }, { t: 34, r: [-33, -3, 0], ease: 'linear' }],
      foot_R: [{ t: 0, r: [0, 0, 0], ease: 'quad' }, { t: 3, r: [-6, 0, 0], ease: 'quart' }, { t: 5, r: [4, 0, 0], ease: 'snap' },
        { t: 7, r: [14, 0, 0], ease: 'sine' }, { t: 9, r: [18, 0, 0], ease: 'quad' }, { t: 13, r: [4, 0, 0], ease: 'cubic' },
        { t: 19, r: [22, 0, 0], ease: 'cubic' }, { t: 26, r: [10.5, 0, 0], ease: 'sine' }, { t: 34, r: [0, 0, 0], ease: 'linear' }],
