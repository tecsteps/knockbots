...
export const KICK_CLIPS = {
  ...
  'k.sweep': {
    ...
    root: [
      ...
      { t: 16, p: [0, -0.36, 0.06], ry: -46, ease: 'linear' },
      { t: 21, p: [0, -0.352, 0.1], ry: -140, ease: 'sine' },
      { t: 30, p: [0, -0.13, 0.08], ry: -180, ease: 'sine' },
    ...
    tracks: {
      ...
      hip_R: [{ t: 0, r: [-9, -6, -12], ease: 'quart' }, { t: 9, r: [-14, 8, -16], ease: 'quart' },
        { t: 16, r: [-52, 13.7, -10], ease: 'linear' }, { t: 21, r: [-30, 12.6, 40], ease: 'sine' },
        { t: 24, r: [-14, 11.6, 44], ease: 'sine' }, { t: 30, r: [-2, 6, -14], ease: 'sine' },
        { t: 40, r: [-9, -6, -12], ease: 'linear' }],
      knee_R: [{ t: 0, r: [45, 0, 0], ease: 'quart' }, { t: 9, r: [66, 0, 0], ease: 'quart' },
        { t: 12, r: [104, 0, 0], ease: 'sine' }, { t: 16, r: [112, 0, 0], ease: 'linear' },
        { t: 21, r: [106, 0, 0], ease: 'sine' }, { t: 24, r: [80, 0, 0], ease: 'sine' },
        { t: 30, r: [42, 0, 0], ease: 'sine' },
        { t: 40, r: [45, 0, 0], ease: 'linear' }],
      ankle_R: [{ t: 0, r: [-33, -3, 0], ease: 'quart' }, { t: 9, r: [-62, -3, 0], ease: 'quart' },
        { t: 16, r: [-26, 0, 0], ease: 'linear' }, { t: 21, r: [-22, 0, 0], ease: 'sine' },
        { t: 24, r: [-14, -0.3, 0], ease: 'sine' }, { t: 30, r: [-57.9, -3, 0], ease: 'sine' },
  ...
  'k.kneeStrike': {
    ...
    tracks: {
      ...
      hip_R: [{ t: 0, r: [-9, -6, -12], ease: 'quad' }, { t: 7, r: [-22.8, -55, -20.4], ease: 'sine' },
        ...
        { t: 18, r: [-74, -8, -9], ease: 'sine' }, { t: 20, r: [-30.1, -38, -13], ease: 'sine' },
        { t: 28, r: [-9, -6, -12], ease: 'linear' }],
      knee_R: [{ t: 0, r: [45, 0, 0], ease: 'quad' }, { t: 7, r: [34, 0, 0], ease: 'sine' },
        { t: 12, r: [75.9, 0, 0], ease: 'sine' }, { t: 15, r: [79.4, 0, 0], ease: 'quad' },
        { t: 18, r: [72, 0, 0], ease: 'sine' }, { t: 20, r: [52, 0, 0], ease: 'sine' },
        { t: 28, r: [45, 0, 0], ease: 'linear' }],
  ...
  'k.stomp': {
    ...
    tracks: {
      ...
      hip_R: [{ t: 0, r: [-9, -6, -12], ease: 'quart' }, { t: 8, r: [-8, 6, -14], ease: 'quart' },
        ...
        { t: 20, r: [-26, 6, -13], ease: 'expo' }, { t: 24, r: [-6, 6, -13], ease: 'quad' },
        { t: 32, r: [-6, 6, -13], ease: 'sine' }, { t: 42, r: [-9, -6, -12], ease: 'linear' }],
      knee_R: [{ t: 0, r: [45, 0, 0], ease: 'quart' }, { t: 8, r: [50, 0, 0], ease: 'quart' },
        { t: 13, r: [80, 0, 0], ease: 'sine' }, { t: 17, r: [74, 0, 0], ease: 'sine' },
        { t: 20, r: [70, 0, 0], ease: 'sine' }, { t: 24, r: [64, 0, 0], ease: 'quad' },
        { t: 32, r: [42, 0, 0], ease: 'sine' }, { t: 42, r: [45, 0, 0], ease: 'linear' }],
